...
export const Home = ({ className }) => (
    <svg role="img" height="24" width="24" className={className} viewBox="0 0 24 24" fill="currentColor">
...
export const Play = ({ className, width = 24, height = 24 }) => (
    <svg role="img" height={height} width={width} viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export const HeartHollow = ({ className }) => (
    <svg role="img" height="16" width="16" viewBox="0 0 16 16" className={className} fill="currentColor">
...
export const AddLibary = ({ className }) => (
    <svg role="img" height="24" width="24" viewBox="0 0 24 24" className={className}>
        <path
